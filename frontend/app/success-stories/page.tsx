...
const TOPICS = [
  {
    title: 'Land restoration projects',
    icon: (
  ...
  {
    title: 'Policy-driven environmental solutions',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="pt-24 pb-16 lg:pt-32 lg:pb-24">
          ...
          <Stagger delay={140}>
            <p className="text-lg lg:text-xl text-gray-400 max-w-3xl mb-4 leading-relaxed" style={sans}>
              Discover successful initiatives addressing land degradation in Africa, including restoration projects and sustainable land management practices.
            </p>
          </Stagger>
          ...
          <Stagger delay={200}>
            <p className="text-sm text-green-400/90 font-medium mb-8" style={{ ...sans, letterSpacing: '0.02em' }}>
              Track indicators. Visualize trends. Inform decisions.
            </p>
          </Stagger>
          ...
          <Stagger delay={260}>
            <p className="text-base text-gray-300 max-w-3xl mb-12 leading-relaxed" style={sans}>
              Across Africa, innovative solutions are helping to combat land degradation and restore ecosystems.
            </p>
          </Stagger>
          ...
          <Stagger delay={320}>
            <p className="text-sm text-white font-medium mb-6" style={sans}>
              Explore success stories on:
            </p>
          </Stagger>

          <div className="grid sm:grid-cols-2 gap-4 max-w-3xl mb-12">
            {TOPICS.map((topic, i) => (
              <Stagger key={topic.title} delay={350 + i * 70}>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Stagger delay={140}>
              <p className="text-gray-400 text-lg mb-10 leading-relaxed" style={sans}>
                Dive into an immersive, scroll-driven investigation of Africa&apos;s land degradation crisis with interactive maps and satellite comparisons.
              </p>
            </Stagger>
