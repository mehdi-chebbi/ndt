...
export default function CompareLegend({ legend, layerName, position }: CompareLegendProps) {
  if (!legend || legend.length === 0) return null

  return (
    <div
      className={`absolute bottom-4 bg-white rounded-lg shadow-lg p-3 z-40 max-w-xs ${
