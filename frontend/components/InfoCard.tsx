...
export default function InfoCard({ text }: InfoCardProps) {
  return (
    <div
      className="flex items-stretch rounded-2xl overflow-hidden max-w-4xl w-full"
      style={{
        background: '#ffffff',
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: '#2e6b27', width: 60, minWidth: 60 }}
      >
        <svg
          version="1.0"
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            <g>
              <path
                fill="#ffffff"
                d="M6.966,61.26c-0.143,0.532-0.691,0.849-1.224,0.707c-0.534-0.145-0.851-0.691-0.708-1.225l2.552-9.686 c0.405,0.672,0.998,1.212,1.712,1.55L6.966,61.26z"
              />
              <path
                fill="#a8e0a0"
                d="M55,27c0,13.233-10.767,24-24,24H11c-1.104,0-2-0.896-2-2v-1V27C9,14.641,18.92,4.769,33.124,2.992 c4.839-0.604,10.391-0.951,15.233-0.951c4.048,0,7.553,0.242,10.238,0.705C55,11.565,55,20.443,55,27z"
              />
              <g>
                <path
                  fill="#ffffff"
      ...
      {/* Right illustration */}
      <div
        className="shrink-0 overflow-hidden flex items-end justify-end"
        style={{ width: 140, minWidth: 140 }}
      >
        <img
          src="/images/ldn-africa/landscape-illustration.svg"
          alt=""
