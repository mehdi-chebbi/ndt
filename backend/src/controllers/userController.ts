...
export const getAllUsers = async (req: AuthRequest, res: Response) => {
  try {
    const result = await pool.query(
      'SELECT id, name, email, role, phone_number, country, job_title, institution, profile_complete, tutorial_completed, created_at FROM users ORDER BY created_at DESC'
    );
